...
public:
	...
	// Returns the view matix calculated using Euler Angles and the LookAt Matrix
	...
	void ProcessMouseMovement(float xOffset, float yOffset, GLboolean constrainPitch = true) {
		...
		// Update Front, Right and up Vectos using the updated Euler angles
		updateCameraVectors();
	}
...
private:
	...
	void updateCameraVectors() {
		...
		Right = glm::normalize(glm::cross(Front, WorldUp)); // Normalize the vectors, because their length gets closer to 0 the more one looks up or down, resulting in slower movement
